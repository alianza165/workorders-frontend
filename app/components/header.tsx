...
import { Bars3Icon, BellIcon, XMarkIcon, SunIcon, MoonIcon, HomeIcon, ChartPieIcon } from '@heroicons/react/24/outline';
...
function NavLink({ href, icon, children }: {
  ...
  return (
    <Link href={href} passHref legacyBehavior>
      <a className="flex items-center hover:bg-teal-600 p-2 rounded-md cursor-pointer">
        {icon}
